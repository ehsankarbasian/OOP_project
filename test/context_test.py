...
class ContextTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.graph.add_edge('azadi_sq', 'tehran_university', edge_weight=9)
        self.graph.add_edge('tehran_university', 'amirkabir_university', edge_weight=2)
        self.graph.add_edge('amirkabir_university', 'IUST', edge_weight=12)
        self.graph.add_edge('tehran_university', 'IUST', edge_weight=10)
        self.graph.add_edge('amirkabir_university', 'resalat_sq', edge_weight=7)
        self.graph.add_edge('tehran_university', 'resalat_sq', edge_weight=8)
        self.graph.add_edge('IUST', 'resalat_sq', edge_weight=5)
        self.graph.add_edge('resalat_sq', 'IUST', edge_weight=3)
        self.graph.add_edge('IUST', 'azadi_sq', edge_weight=28)
        self.graph.add_edge('IUST', 'amirkabir_university', edge_weight=11)
        ...
        self.graph_1.add_edge(self.private_location_1.name, 'tehran_university', edge_weight=6)
        self.graph_1.add_edge('resalat_sq', self.private_location_1.name, edge_weight=5)
        self.graph_2.add_node(self.private_location_2.name)
        self.graph_2.add_edge(self.private_location_2.name, 'amir_kabir_university', edge_weight=2)
        self.graph_2.add_edge('tehran_university', self.private_location_1.name, edge_weight=1)
