...
graph.add_edge('azadi_sq', 'tehran_university', edge_distance=9)
graph.add_edge('tehran_university', 'amirkabir_university', edge_distance=2)
graph.add_edge('amirkabir_university', 'IUST', edge_distance=12)
graph.add_edge('tehran_university', 'IUST', edge_distance=10)
graph.add_edge('amirkabir_university', 'resalat_sq', edge_distance=7)
graph.add_edge('tehran_university', 'resalat_sq', edge_distance=8)
graph.add_edge('IUST', 'resalat_sq', edge_distance=5)
graph.add_edge('resalat_sq', 'IUST', edge_distance=3)
graph.add_edge('IUST', 'azadi_sq', edge_distance=28)
graph.add_edge('IUST', 'amirkabir_university', edge_distance=11)
...
graph_1.add_edge(private_location_1.name, 'tehran_university', edge_distance=6)
graph_1.add_edge('resalat_sq', private_location_1.name, edge_distance=5)
graph_2.add_node(private_location_2.name)
graph_2.add_edge(private_location_2.name, 'amir_kabir_university', edge_distance=2)
graph_2.add_edge('tehran_university', private_location_1.name, edge_distance=1)
